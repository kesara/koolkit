...
void print_help (void)
{
    ...
    fprintf (stdout, "  --stats\tprint user statictics.\n");
    fprintf (stdout, "  --help\tprint help\n");
    fprintf (stdout, "  --version\tprint version\n");
    fprintf (stdout, "\nReport bugs to ");
    fprintf (stdout, "http://code.google.com/p/koolkit/issues/\n");
}
 ...
 */
void print_usage (FILE *iostream)
{
